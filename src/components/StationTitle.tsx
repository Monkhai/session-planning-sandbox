...
const StationTitle = ({
  ...
  return (
    <textarea
      ...
      ref={stationNameRef}
      className="placeholder:text-textInput box-border w-full resize-none bg-transparent text-xl font-semibold outline-none active:outline-none  print:w-full print:text-base print:font-medium"
